...
if __name__ == "__main__":
    ...
    metric_config = {
        ...
        "longi.MMD": {"kernel": "sig rbf", "sigmas": [0.3, 0.5, 1, 10, 60, 100, 400], "dyadic_order":1, "lead_lag":False, "subtrack_init_point":False, "scale_time":True},
    ...
    for i in range(gen_idx_block*5, (gen_idx_block+1)*5):
        ...
        syn_files = sorted(
            ...
            + list(dir.glob("OUR_Hnsde_posterior_drift.npz"))
