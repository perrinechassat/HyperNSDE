...
if __name__ == "__main__":
    ...
    metric_config = {
        ...
        "prediction_score": {"predictor_type": "S4", "filling_type": 'last',  "verbose": False, "input_len": 200}, #"future_steps": 5,
    ...
    for i in range(gen_idx_block*10, (gen_idx_block+1)*10):
        ...
        try:    
            ...
            real_all, real_train, real_test, scales = build_real_sets(real, method_scaling="standard")
        ...
        syn_files = sorted(
            ...
            # + list(dir.glob("OUR_Hnsde_reconstruction_drift.npz"))
            # + list(dir.glob("OUR_Hnsde_prior.npz"))
        )
        # syn_files = sorted(
        #     + list(dir.glob("OUR_only_ODE_posterior.npz"))
        #     + list(dir.glob("OUR_sde_training_Hnsde_posterior.npz"))
        # )
        ...
        for syn_file in syn_files:
            ...
            if model_name == "MultiNODEs":
                multiNODEs_mask = real_test["M"] #expand_mask_to_last_obs(real_test["M"])
            else:
        ...
        if rows:
            ...
            # out_path = RESULTS_DIR / "metrics_{}.csv".format(dataset_name)
